...
FROZEN = [
    {"id": "xsec-short-w5", "kind": "short", "direction": "low", "window": 5,
     ...
     "verdict": "illiquidity 아티팩트 — 유동성필터 3방식(백분위0.3·고정50억·시기일관 중앙0.3배) 전부 게이트 탈락(exIR 1.94→1.1~1.3, 최악연도 IR 음수). 거래 불가, 관찰만"},
    {"id": "xsec-short-w5-liq30", "kind": "short", "direction": "low", "window": 5,
     ...
     "verdict": "tradable 기준 IS 게이트 탈락(exIR 1.15, 최악연도 IR −2.0). 고정50억·시기일관 임계도 동일 탈락. 엣지 아님 — forward 추적"},
